...
if ( ! defined( 'ACFFA_PUBLIC_PATH' ) ) {
	define( 'ACFFA_PUBLIC_PATH', RBFWPSTARTERTHEME_URL."/includes/plugins/advanced-custom-fields-font-awesome/" );
}
	...
	class acf_plugin_font_awesome {
		...
		public function init()
		{
			...
			$this->settings = array(
				...
				'url'		=> RBFWPSTARTERTHEME_URL."/includes/plugins/advanced-custom-fields-font-awesome/",
				'path'		=> RBFWPSTARTERTHEME_PATH."/includes/plugins/advanced-custom-fields-font-awesome/",
			);
