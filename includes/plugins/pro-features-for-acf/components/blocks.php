...
function acf_enqueue_block_assets() {
	...
	// Enqueue script.
	wp_enqueue_script( 'acf-blocks', FREEACFPROFEATURES_URL."/components/assets/js/acf-pro-blocks.min.js", ['acf-input', 'wp-blocks'], FREEACFPROFEATURES_COMPONENTS_VERSION, true );
